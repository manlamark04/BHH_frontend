        ...
        <form onSubmit={handleSubmit} className="space-y-5 text-xs">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2.5 rounded-xl border bg-[#F6F2E8] text-ink font-medium focus:outline-none focus:ring-2 focus:ring-[#6B7A5E]/40 ${
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl border border-stone bg-[#F6F2E8] text-ink font-medium focus:outline-none focus:ring-2 focus:ring-[#6B7A5E]/40"
              />
            </div>
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2.5 rounded-xl border bg-[#F6F2E8] text-ink font-mono text-xs focus:outline-none focus:ring-2 focus:ring-[#6B7A5E]/40 ${
          ...
          <div>
            ...
            <textarea
              ...
              className={`w-full px-4 py-2.5 rounded-xl border bg-[#F6F2E8] text-ink font-medium resize-none focus:outline-none focus:ring-2 focus:ring-[#6B7A5E]/40 ${
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-xl border border-stone bg-[#F6F2E8] text-ink font-mono focus:outline-none focus:ring-2 focus:ring-[#6B7A5E]/40"
            />
          </div>
          ...
          <div className="pt-3 border-t border-stone/15">
            <button
              type="submit"
              disabled={submitting}
              className="w-full py-3 bg-[#6B7A5E] hover:bg-[#4F5D45] text-white font-semibold rounded-xl text-xs shadow-sm hover:shadow-md transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            >
      ...
      >
        {result && (
          <div className="space-y-4 text-xs font-sans">
            ...
            {/* Generated ID Badge */}
            <div className="bg-[#F6F2E8] border border-stone/20 rounded-2xl p-5 text-center">
              <span className="text-[10px] font-bold uppercase tracking-widest text-[#6B7A5E]">Official Customer ID</span>
            ...
            <div className="p-4 bg-[#F6F2E8] border border-stone/20 rounded-2xl space-y-3">
              <div className="flex justify-between items-center pb-2 border-b border-stone/15">
                ...
                <button
                  ...
                  className="text-xs font-semibold text-[#6B7A5E] hover:underline flex items-center gap-1"
                >
                  {copied ? (
                    <>
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                ...
                <div>
                  ...
                  <strong className="font-mono text-[#6B7A5E] text-sm">{result.customer_id}</strong>
                </div>
            ...
            <button
              ...
              className="w-full py-2.5 bg-[#6B7A5E] hover:bg-[#4F5D45] text-white rounded-xl font-semibold shadow-sm text-xs"
            >
